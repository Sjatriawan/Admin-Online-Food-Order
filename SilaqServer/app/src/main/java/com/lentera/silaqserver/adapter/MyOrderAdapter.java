...
public class MyOrderAdapter  extends RecyclerView.Adapter<MyOrderAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Common.setSpanStringColor("Tanggal Pesanan: ",simpleDateFormat.format(orderModelList.get(position).getCreateDate()),
                holder.txt_time, Color.parseColor("#333639"));
        Common.setSpanStringColor("Status: ",Common.convertStatusToString(orderModelList.get(position).getOrderStatus()),
                holder.txt_order_status, Color.parseColor("#00579A"));
        Common.setSpanStringColor("Nama:  ",orderModelList.get(position).getUserName(),
                holder.txt_name, Color.parseColor("#00574B"));
        Common.setSpanStringColor("Jumlah:  ",orderModelList.get(position).getCartItemList() == null ? "0":
    ...
    public OrderModel getItemAtPosition(int pod) {
        return orderModelList.get(pod);
    }
    public void removeItem(int pod) {
        orderModelList.remove(pod);
    }
