...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subsribeToTopic(Common.createTopicOrder());
        updateToken();
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_category, R.id.nav_food_list, R.id.nav_order, R.id.nav_best_deal, R.id.nav_most_popular,R.id.nav_driver)
    ...
    private void subsribeToTopic(String topicOrder) {
    ...
    public void onToastEvent(ToastEvent event){
        ...
        {
            Toast.makeText(this, "Create Sukses", Toast.LENGTH_SHORT).show();
    ...
    @Subscribe(sticky = true,threadMode = ThreadMode.MAIN)
    public void onChangeClick(ChangeMenuCLick event){
