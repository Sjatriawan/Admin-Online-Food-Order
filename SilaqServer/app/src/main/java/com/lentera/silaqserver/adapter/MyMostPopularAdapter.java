...
public class MyMostPopularAdapter extends RecyclerView.Adapter<MyMostPopularAdapter.MyViewHolder> {
    ...
    Context context;
    List<MostPopularModel> mostPopularModelsList;

    public MyMostPopularAdapter(Context context, List<MostPopularModel> mostPopularModelsList) {
        this.context = context;
        this.mostPopularModelsList = mostPopularModelsList;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Glide.with(context).load(mostPopularModelsList.get(position).getImage())
                .into(holder.category_image);
        holder.category_name.setText(new StringBuilder(mostPopularModelsList.get(position).getName()));
    ...
    public int getItemCount() {
        return mostPopularModelsList.size();
    }
